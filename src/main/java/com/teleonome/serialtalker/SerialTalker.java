...
//	Logger logger;
	String SerialPortID = "ttyUSB0";
	private static final String PORT_NAMES[] = { "/dev/tty.usbmodem641", "/dev/ttyACM0", "/dev/ttyAMA0", "/dev/ttyACM1","ttyUSB0","/dev/ttyUSB1","/dev/cu.usbmodem1411" };
